...
(function (angular) {
     ...
     */
    angular.module(moduleName).factory('businessPartnerContactListDataService',
        ['businessPartnerHttpService', '$q', 'commonBusinessPartnerDataService', 'businessPartnerContactListHttpService',
            function (businessPartnerHttpService, $q, commonBusinessPartnerDataService, businessPartnerContactListHttpService) {
                ...
                service.fillBusinessPartner = function (businessPartners) {
                    if (businessPartners.length) {
                        businessPartners.forEach(function (businessPartner) {
                            ...
                            businessPartner.role = 'General Manage';
                        })
                    }
                };

                service.getContactListByBusinessPartnerId = function (businessPartnerId) {
                    var defer = $q.defer();
                    businessPartnerContactListHttpService.getContactListByBusinessPartnerId(businessPartnerId)
                ...
                service.loadCountriesByFilter=function(options){
                    var defer = $q.defer();
                    businessPartnerContactListHttpService.loadCountriesByFilter(options).then(
                        function (response) {
                            try {
