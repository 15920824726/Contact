...
(function (angular) {
    ...
    angular.module(moduleName).controller('bpContactdetailController', [
        '$scope','bpContactImgDataService','bpcontactDetailService','$stateParams','platformTranslateService','phoneHelper'
        ,'commonFavoriteDataService','$ionicPopup','$timeout','commonBusinessPartnerDataService','$ionicLoading','$ionicHistory','contactDetailDataService',
        function ($scope,bpContactImgDataService,bpcontactDetailService,$stateParams,platformTranslateService
            ,phoneHelper,commonFavoriteDataService,$ionicPopup,$timeout,commonBusinessPartnerDataService,$ionicLoading,$ionicHistory,contactDetailDataService) {
            ...
            function getImageData(options){
                bpContactImgDataService.getImagData(options).then(function(res){
                    //debugger;
                    if(res && res.photo){
            ...
            function loadTranslations() {
                $scope.translate = platformTranslateService.instant({
                    businessPartner: ['Telephone','OtherTelephone', 'Mobile', 'message', 'Fax', 'Email', 'Favorite', 'Edit'
                        , 'FirstName', 'FamilyName', 'MobilePhone', 'Add', 'Update','Success','Failure','addFtSuccess','removeFt']
                });
            }
                            ...
                            ctx.executeSql(selectSQL, [$stateParams.contactId], function (ctx, result) {
                                ...
                                if (result.rows.length >= 1) {
                                    ...
                                    var mypopup=$ionicPopup.alert( {
                                        scope: $scope,
                                        template:'<p style="text-align: center;font-size: larger"ng-bind="translate.businessPartner.removeFt"></p>',
                                        buttons:null,
                                        title:'Tips:'
                                    } );
                                    ...
                                    var mypopup=$ionicPopup.alert( {
                                        scope: $scope,
                                        template:'<p style="text-align: center;font-size: larger" ng-bind="translate.businessPartner.addFtSuccess"></p>',
                                        buttons:null,
                                        title:'Tips:'
                                    });
                                    $('.popup-container .popup .popup-head').css('background-color','#0167b1');
                                    ...
                                    $timeout(function(){
                                        mypopup.close();
                                        $('#favoriteBtn').addClass('add'+$stateParams.contactId);
                                        $('#favoriteBtn').css('color','red');
                                    } ,1500);
                                }
                            }, function (ctx, result) {
                                console.log("false");
            ...
            function updateContact(companyCode,data,base){
                ...
                if(mobile&&data.mobile){
                    options.Contact.MobileToSave={
                        "id":mobile.id,
                        "telephone":"",
                        "PhoneNumber":data.mobile.phoneNumber|| data.mobile.telephone,
            ...
            $scope.update = function (userInfoForm) {
                ...
                if (userInfoForm.$valid) {
                    showLoading();
                    //save photo
                    // $scope.imageDataBase64="";
            ...
            $scope.backBPContactList=function(){
                $ionicHistory.goBack();
            }
            ...
            function LoadData(){
                ...
                bpcontactDetailService.getContactDetail($scope.options).then(function(response){
                    console.log("contacdetailresponse"+response);
                    $scope.contact=response;
                    $scope.imageData=  "data:image/png;base64,";

                    $scope.contact.imageData=$scope.imageData;
                    bpContactImgDataService.getImagData($scope.imgOptions).then(function(res){
                        //debugger;
                        if(res && res.photo){
                            $scope.imageData='data:image/png;base64,'+ res.photo;
                        }
                ...
                try {
                    db.transaction(function(ctx,result  ){
                        ctx.executeSql( selectSQL,[$stateParams.contactId],function(ctx,result){
                            ...
                            if (result.rows.length >= 1) {
                                $('#bp-contact-detail #favoriteBtn').css('color','red');
                            }else {
                                $('#bp-contact-detail #favoriteBtn').css('color','black');
                            }
                        } ,function(ctx,result){
                            console.log(result)
            ...
            function init() {
                ...
                initDB();
                $scope.bpname= commonBusinessPartnerDataService.returnBpName();
                LoadData();
            }
