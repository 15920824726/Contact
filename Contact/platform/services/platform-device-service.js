...
(function (angular, $) {
	'use strict';
	angular.module('platform').factory('platformsDeviceService', platformsDeviceService);

	//platformsDeviceService.$inject = ['$http', '$q'];
	function platformsDeviceService() {//jshint ignore:line

		var device = {};

		function initDeviceService() {//jshint ignore:line
